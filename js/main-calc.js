...
var pageHeaderConsultBtn = document.getElementsByClassName('calc-page-header__consult-btn');
...
$(document).ready(function(){
  $(telephoneFieldLast).inputmask("+9 (999) 999-9999"); //specifying options
});

$(document).ready(function(){
  $(telephoneFieldLite).inputmask("+9 (999) 999-9999"); //specifying options
});
